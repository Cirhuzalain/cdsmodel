from dataloader.dataset import DataLoader, Field

def load_dataset(opt, data_path, vocab_path, device, train=True):
    src = data_path[0]
    tgt = data_path[1]
    ...
    return DataLoader(src, tgt, opt.batch_size, device, train, 
                            {"src" : src_field, "tgt" : tgt_field}, opt)