...
def common_opts(parser):
    ...
    parser.add_argument("-max_length", type=int, default=200, help="Maximun prediction length")
...
def train_opts(parser):
    ...
    parser.add_argument("-max_to_keep", type=int, default=5, help="How many checkponts to keep")
...
def model_opts(parser):
    parser.add_argument("-layers", type=int, default=6, help="Number of layer")
...
def sum_opts(parser):
    parser.add_argument("-input", type=str, help="Summarization data")
    parser.add_argument("-truth", type=str, default=None, help="Y target, used for ROUGE evaluation")
